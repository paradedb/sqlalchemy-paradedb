...
def test_alembic_command_autogenerate_upgrade_and_downgrade_paradedb_index(engine, alembic_config_factory):
    ...
    try:
        ...
        command.revision(config, message="add ParadeDB index", autogenerate=True, rev_id="rev_static")
...
def upgrade() -> None:
    ...
    op.create_paradedb_index('search_idx', 'mock_items', ['id', 'description', 'category', 'rating', 'in_stock', 'metadata', 'created_at', 'last_updated_date', 'latest_available_time', 'weight_range'], key_field='id', table_schema='alembic_cmd_static')
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_paradedb_index('search_idx', if_exists=True, schema='alembic_cmd_static')
    # ### end Alembic commands ###
''',
        )
...
def test_alembic_command_autogenerate_changed_paradedb_index(engine, alembic_config_factory):
    ...
    try:
        ...
        command.revision(config, message="update ParadeDB index", autogenerate=True, rev_id="rev_changed_static")
        _assert_generated_migration(
            config,
            '''"""update ParadeDB index
...
def upgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_paradedb_index('search_idx', if_exists=True, schema='alembic_cmd_changed_static', table_name='mock_items', expressions=['id', 'description'], key_field='id')
    op.create_paradedb_index('search_idx', 'mock_items', ['id', 'description', 'category', 'rating', 'in_stock', 'metadata', 'created_at', 'last_updated_date', 'latest_available_time', 'weight_range'], key_field='id', table_schema='alembic_cmd_changed_static')
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_paradedb_index('search_idx', if_exists=True, schema='alembic_cmd_changed_static')
    op.create_paradedb_index('search_idx', 'mock_items', ['id', 'description'], key_field='id', table_schema='alembic_cmd_changed_static')
    # ### end Alembic commands ###
''',
        )
